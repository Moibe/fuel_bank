...
class __TwigTemplate_bf6140797673e5666379874de7c138cce1a1b00ac03729100a6e965eddea3a70 extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        // line 4
        echo "    ";
        if ($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "isEasyAdminAction", array())) {
            // line 5
            echo "        ";
    ...
    public function block_menu($context, array $blocks = array())
    {
        ...
        echo (( !$this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "isEasyAdminAction", array())) ? ("disabled") : (""));
        echo "\">
        <span class=\"icon\">";
        // line 31
        ...
        <div class=\"sf-tabs\">
            ...
            <div class=\"tab\">
                ...
                <div class=\"tab-content\">
                    ...
                    ";
            // line 99
            echo $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "dump", array(0 => array("site_name" => $this->getAttribute($this->getAttribute(            // line 100
(isset($context["collector"]) ? $context["collector"] : null), "backendConfig", array()), "site_name", array(), "array"), "formats" => $this->getAttribute($this->getAttribute(            // line 101
(isset($context["collector"]) ? $context["collector"] : null), "backendConfig", array()), "formats", array(), "array"))), "method");
            ...
            echo "
                    ...
                    ";
            // line 105
            echo $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "dump", array(0 => array("design" => $this->getAttribute($this->getAttribute(            // line 106
(isset($context["collector"]) ? $context["collector"] : null), "backendConfig", array()), "design", array(), "array"))), "method");
            ...
            echo "
                    ...
                    ";
            // line 110
            echo $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "dump", array(0 => array("disabled_actions" => $this->getAttribute($this->getAttribute(            // line 111
(isset($context["collector"]) ? $context["collector"] : null), "backendConfig", array()), "disabled_actions", array(), "array"), "list" => $this->getAttribute($this->getAttribute(            // line 112
(isset($context["collector"]) ? $context["collector"] : null), "backendConfig", array()), "list", array(), "array"), "edit" => $this->getAttribute($this->getAttribute(            // line 113
(isset($context["collector"]) ? $context["collector"] : null), "backendConfig", array()), "edit", array(), "array"), "new" => $this->getAttribute($this->getAttribute(            // line 114
(isset($context["collector"]) ? $context["collector"] : null), "backendConfig", array()), "new", array(), "array"), "show" => $this->getAttribute($this->getAttribute(            // line 115
(isset($context["collector"]) ? $context["collector"] : null), "backendConfig", array()), "show", array(), "array"))), "method");
            ...
            echo "
                    ...
                    ";
            // line 119
            echo $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "dump", array(0 => array("entities" => $this->getAttribute($this->getAttribute(            // line 120
(isset($context["collector"]) ? $context["collector"] : null), "backendConfig", array()), "entities", array(), "array"))), "method");
            ...
            echo "
                    ...
                    ";
            // line 124
            echo $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "dump", array(0 => array("easy_admin" => $this->getAttribute(            // line 125
...
";
    ...
    {
        return new Twig_Source("", "EasyAdminBundle:data_collector:easyadmin.html.twig", "/home/moibe/webapps/fuel_bank/vendor/javiereguiluz/easyadmin-bundle/src/Resources/views/data_collector/easyadmin.html.twig");
    }
}
